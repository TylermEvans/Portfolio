...
class TileMap(object):
    def __init__(self,screen,mapWidth=25,mapHeight=19,tileWidth=32,tileHeight=32,screenWidth=800,screenHeight=600):
        ...
        self.worldWidth=mapWidth*tileWidth
        self.worldHeight=mapWidth*tileWidth
        self.cameraX=self.worldWidth/2
        self.cameraY=self.worldHeight/2
        for row in range(0,mapHeight):
            self.tileMap.append([None]*(mapWidth+1))
        self.tileTypes={}
