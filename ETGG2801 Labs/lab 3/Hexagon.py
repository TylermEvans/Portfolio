...
class Hexagon:
    ...
    def __init__(self):
        ...
        vdata = array.array("f",[0.0,0.0 , 0.25,0.5 , -0.25,0.5 , 0.0,0.0 , 0.5,0.0 , 0.25,0.5 , 0.0,0.0 , 0.25,-0.5 , 0.5,0.0 , 0.0,0.0 , -0.25,-0.5 , 0.25,-0.5 , 0.0,0.0 , -0.5,0.0 , -0.25,-0.5 , 0.0,0.0 , -0.25,0.5 , -0.5,0.0] )
