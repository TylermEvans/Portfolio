...
while 1:
    while 1:
        ...
        if ev.type == sdl2.SDL_QUIT:
            ...
            if k == SDLK_SPACE:
                fire = True
                bullet_list.append(Bullet.Bullet(0.001,0,worldMatrix))
    ...
    if SDLK_d in keys:
        worldMatrix = worldMatrix * math3d.translation([sqaure_x*elapsed,0,0])
    if SDLK_a in keys:
        worldMatrix = worldMatrix * math3d.translation([-sqaure_x*elapsed,0,0])
    if SDLK_w in keys:
        worldMatrix = worldMatrix * math3d.translation([0,sqaure_y*elapsed,0])
    if SDLK_s in keys:
        worldMatrix = worldMatrix * math3d.translation([0,-sqaure_x*elapsed,0])
