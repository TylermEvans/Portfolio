...
public:
	...
	static BBProgram* active;

	BBProgram(const BBProgram&) = delete;
	...
	BBProgram(string vsfname, string fsfname)
	{
		GLint tmp[1];
		...
		glBindAttribLocation(prog, BBProgram::POSITION_INDEX, "a_position");
		glBindAttribLocation(prog, BBProgram::TEXCOORD_INDEX, "a_texcoord");
